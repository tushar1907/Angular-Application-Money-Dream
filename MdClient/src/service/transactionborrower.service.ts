...
export class TransactionBorrowerSerivce {
    ...
    deleteTransactioURL =  'http://localhost:3000/deleteTransaction';
...
deleteTransaction(transac : Transaction) : Promise<any>{
  let promise = new Promise((resolve, reject) => {
    this.http
    .post<Transaction>(this.deleteTransactioURL,{transac : transac})
    .subscribe(data => {
      console.log(JSON.stringify(data));
      resolve(data);
    },
